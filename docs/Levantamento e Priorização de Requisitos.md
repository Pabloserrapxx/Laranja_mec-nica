...
| RF30 | O sistema deve oferecer integração com serviços de entrega para cálculo automático de frete e rastreamento de pedidos.                            | 3              | 2       | 4          |
...
| ID     | Requisito Não Funcional                                                                                                                   | Valor Agregado | Esforço | Prioridade |
|--------|------------------------------------------------------------------------------------------------------------------------------------------|----------------|---------|------------|
